...
import covid19_management_system.views.CachLy.ShowTest;
...
public class TrangChu extends javax.swing.JFrame {
    ...
    public void showThongKe() {
        ...
        jLabelSoNguoiTestCovid.setText(Integer.valueOf(thongKeModel.getSoNguoiTestCovid()).toString().trim());
    }
    ...
    private void initComponents() {
        ...
        jLabelSoNguoiTestCovid = new javax.swing.JLabel();
        jButtonSoNguoiTestCovid = new javax.swing.JButton();
        ...
        jLabel15.setText("+ Số người đã test covid:");

        jLabelSoNguoiTestCovid.setBackground(new java.awt.Color(255, 255, 255));
        jLabelSoNguoiTestCovid.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabelSoNguoiTestCovid.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jButtonSoNguoiTestCovid.setText("XEM");
        jButtonSoNguoiTestCovid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonSoNguoiTestCovidActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(jLabelSoNguoiTestCovid, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jButtonSoNguoiTestCovid)))))))
                .addGap(47, 47, 47))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButtonSoNguoiTestCovid, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabelSoNguoiTestCovid, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//        });
    ...
    private void jButtonSoNguoiTestCovidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSoNguoiTestCovidActionPerformed
        ShowInfoAllNhanKhau temp = new ShowInfoAllNhanKhau();
        temp.setLocationRelativeTo(null);
        temp.setResizable(false);
        temp.setVisible(true);
        // sửa
        temp.setTitle("Trường hợp đã test covid");
        temp.getjLabelTitle().setText("Các nhân khẩu đã test covid");
        String query = "SELECT DISTINCT nhan_khau.ID, nhan_khau.chungMinhThu, nhan_khau.hoTen, nhan_khau.ngaySinh, nhan_khau.gioiTinh, nhan_khau.diaChi, nhan_khau.soDienThoai FROM nhan_khau INNER JOIN test_covid ON (nhan_khau.ID = test_covid.IDNhanKhau) WHERE 1";
        temp.getShowTableNhanKhauController().showNhanKhauWithStr(temp.getjTableNhanKhau(), query.trim());
        ...
        temp.getjButtonCHOOSE().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                temp.getjTFShowCMT().setText(chungMinhThu.trim());
                IDNhanKhau = editNhanKhauController.searchIDFromCMT(chungMinhThu);

                ShowTest showTest = new ShowTest(IDNhanKhau);
                showTest.setTitle("Thông tin test covid của CMT: " + chungMinhThu);
                showTest.setLocationRelativeTo(null);
                showTest.setResizable(false);
                showTest.setVisible(true);
                showTest.getjLabelTitle().setText(("CÁC LẦN TEST COVID CỦA NHÂN KHẨU CÓ CMT: " + chungMinhThu).trim());
            }
        });


    }//GEN-LAST:event_jButtonSoNguoiTestCovidActionPerformed
    ...
    private javax.swing.JButton jButtonSoNguoiTestCovid;
    ...
    private javax.swing.JLabel jLabelSoNguoiTestCovid;
